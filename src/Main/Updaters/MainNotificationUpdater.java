 ...
 * @author Samuel
 */
public class MainNotificationUpdater extends Application{
    ...
    Parent root = FXMLLoader.load(getClass().getResource("/View/Updaters/NotificationUpdater.fxml"));  // Loading a Parent with the JavaFX window fxml  //  Carregando um Parent com o fxml da janela JavaFX
        ...
        stage.setTitle("Update");          // put the icon in the window  //  poe o titulo na janela
    ...
    public static void setWindow(Stage window) {
        MainNotificationUpdater.window = window;
    }
