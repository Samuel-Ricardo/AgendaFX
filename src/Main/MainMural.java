 ...
 * @author Samuel
 */
public class MainMural extends Application{
    ...
    Parent root = FXMLLoader.load(getClass().getResource("/View/Mural.fxml"));  // Loading a Parent with the JavaFX window fxml  //  Carregando um Parent com o fxml da janela JavaFX
        ...
        stage.setTitle("Mural");          // put the icon in the window  //  poe o titulo na janela
