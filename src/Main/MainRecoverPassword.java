 ...
 * @author Samuel
 */
public class MainRecoverPassword extends Application{
    ...
    Parent root = FXMLLoader.load(getClass().getResource("/View/RecoverPassword.fxml"));  // Loading a Parent with the JavaFX window fxml  //  Carregando um Parent com o fxml da janela JavaFX
        ...
        stage.setTitle("Recuperar senha");          // put the icon in the window  //  poe o titulo na janela
    ...
    public static void setWindow(Stage window) {
        MainRecoverPassword.window = window;
    }
