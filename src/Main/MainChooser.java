...
public class MainChooser extends Application{
    ...
    Parent root = FXMLLoader.load(getClass().getResource("/View/Chooser.fxml"));  // Loading a Parent with the JavaFX window fxml  //  Carregando um Parent com o fxml da janela JavaFX
        ...
        stage.setTitle("Chooser");          // put the icon in the window  //  poe o titulo na janela
