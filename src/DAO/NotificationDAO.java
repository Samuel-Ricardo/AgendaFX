...
public class NotificationDAO {
    ...
    public List<Notification> selectAll() {
        ...
        try {
            ...
            while (result.next()) {
                ...
                Notification notification = generateNotification(result);
    ...
    public Notification generateNotification(ResultSet result) throws SQLException {
    ...
    public List<Notification> selectAllFromUser(int id) {
        ...
        try {
            ...
            while (result.next()) {
                ...
                Notification notification = generateNotification(result);     // create Notification with database data  // criando notificacao com dados do banco de dados
